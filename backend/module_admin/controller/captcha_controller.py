...
from domains.admin.application.services import CaptchaService
...
async def get_captcha_image(request: Request):
    ...
    return ResponseUtil.success(
        msg='获取图片验证码成功',
        data={'captchaEnabled': captcha_enabled, 'registerEnabled': register_enabled, 'img': image, 'uuid': session_id}
    )
