...
async def query_detail_system_user_profile(
    ...
    if profile_user_result.data:
        profile_user_result.data.avatar = _build_avatar_url(
            request, getattr(profile_user_result.data, 'avatar', None)
        )
...
async def query_detail_system_user(
    ...
    if detail_user_result.data:
        detail_user_result.data.avatar = _build_avatar_url(
            request, getattr(detail_user_result.data, 'avatar', None)
        )
